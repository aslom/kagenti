...
# SANDBOX_DIR and PROJECT_DIR are both the current directory.
PROJECT_REAL="$(pwd -P)"
SANDBOX_REAL="$PROJECT_REAL"

# Sandbox profile: defaults to agent-sandbox.sb next to this script.
...
/usr/bin/sandbox-exec \
  ...
  -D CLAUDE_BIN="$(dirname "${CLAUDE_BIN:-$HOME/.local/bin/claude}")" \
